...
class Users(models.Model):
    ...
    def _check_credentials(self, password, env):
        print("---------(module: base)----(line:369)---(res_user.py)")
        ...
        try:
            with cls.pool.cursor() as cr:
                ...
                with self._assert_can_auth():
                    ...
                    print("----(module : base )--(line:700)--(res_user.py)-----")
    ...
    def authenticate(cls, db, login, password, user_agent_env):
        print("\n\n----(base / res_user.py ---- def authenticate--- (line 716) ---::: db: "
              , db, "\n-------:::login :", login, "\n-------:::key :", password
        ...
        if user_agent_env and user_agent_env.get('base_location'):
            print("\n----(base / res_user.py ---- def authenticate--- (line 731) ---::: if user_agent_env:")
            with cls.pool.cursor() as cr:
                print("\n----(base / res_user.py ---- def authenticate-----)--- (line 733) ---::: with cls.pool.cursor():",cr)
                env = api.Environment(cr, uid, {})
                print("\n----(base / res_user.py ---- def authenticate--- (line 735) ---::: env :",env)
                if env.user.has_group('base.group_system'):
                    # Successfully logged in as system user!
                    # Attempt to guess the web base url...
                    try:
                        base = user_agent_env['base_location']
                        print("\n----(base / res_user.py ---- def authenticate--- (line 741) ---::: base:",base)
                        ICP = env['ir.config_parameter']
                        print("\n----(base / res_user.py ---- def authenticate--- (line 743) ---::: ICP:",ICP)
                        if not ICP.get_param('web.base.url.freeze'):
                            print("\n----(base / res_user.py ---- def authenticate--- (line 745) ---::: if not ICP.get_param:")
                            ICP.set_param('web.base.url', base)
                    except Exception:
                        _logger.exception("Failed to update web.base.url configuration parameter")
        print("\n\n------(base / res_user.py ---(line 742)--- def authenticate-----( return uid )--- (line 749) ---::: uid: ", uid)
        return uid
    ...
    def check(cls, db, uid, passwd):
        ...
        with contextlib.closing(cls.pool.cursor()) as cr:
            ...
            with self._assert_can_auth():
                ...
                print("----(module : base )---(line:756)---(model : 'res_user'')----")
    ...
    def change_password(self, old_passwd, new_passwd):
        ...
        print("---------(module: base)---(line:798)----(res_user.py)")
...
class CheckIdentity(models.TransientModel):
    ...
    def run_check(self):
        ...
        try:
            ...
            print("---------(module: base)----(line:1562)---(res_user.py)")
        except AccessDenied:
...
class APIKeysUser(models.Model):
    ...
    def _check_credentials(self, password, user_agent_env):
        print("---------(module: base)----(line:1644)---(res_user.py)")
...
class APIKeys(models.Model):
    ...
    def _check_credentials(self, *, scope, key):
        print("---------(module: base)----(line:1731)---(res_user.py)")
